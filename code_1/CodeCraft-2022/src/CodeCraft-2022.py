...
# 小规模场景，已经大规模场景的预处理
process_little(input_data, every_site_biggest_cnt, site_arr, client_arr, file_handle, origin_time_client_site)
...
func_4(input_data, site_arr, client_arr, file_handle, origin_time_client_site, every_site_biggest_cnt, start_time)
